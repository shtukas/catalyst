...
class Datablobs
    ...
    # BladesConfig::path_to_merkle()
    def self.path_to_merkle()
        "#{Config::pathToCatalystDataRepository()}/merkle"
    end

    # BladesConfig::path_to_datablobs()
    def self.path_to_datablobs()
        "#{Config::pathToCatalystDataRepository()}/merkle/datablobs"
    end
    ...
    def self.putBlob(datablob) # nhash
        ...
        filename = "#{nhash}.data"
        folder   = "#{BladesConfig::path_to_datablobs()}/#{fragment}"
